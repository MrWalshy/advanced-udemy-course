var instructor = {
    firstName: "Bob",
    // A regular function is used here, this is so the sayHi function
    // has its own keyword 'this' referring to the instructor object
    sayHi: function(){
        setTimeout(() => {
            // 'this' is referring to the enclosing context, the sayHi
            // function which has its own context of 'this'
            console.log("Hello " + this.firstName);
        }, 1000);
    }
}

instructor.sayHi(); // Hello Bob
